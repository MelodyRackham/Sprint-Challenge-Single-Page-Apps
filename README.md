...
> Answer: A few benefits of client side routing include less data being processed and
> routing between views being generally faster. Also, it allows for smooth transitions and
> animations between views being easier to implement.
